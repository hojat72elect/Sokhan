...
for i, db_entry in enumerate(db0):
    ...
    try:
        ...
        print(f"The {db_entry} was added to the dictionary. ({i + 1}/{len(db0)})")
...
print(f"Successfully processed {len(resulting_dictionary_part0)}/{len(db0)} entries")
